...
export class UpdateAccountComponent implements OnInit {
  ...
  update() {
    this.api.updateStudent(this.router.snapshot.params.id, this.userUpdate.fullname, this.userUpdate.birthday, this.userUpdate.email, this.userUpdate.level).subscribe(res => {
